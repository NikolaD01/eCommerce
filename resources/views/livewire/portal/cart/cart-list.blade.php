            ...
            @foreach($cart['items'] as $item)
                <div class="grid grid-cols-1 lg:grid-cols-2 min-[550px]:gap-6 border-t border-gray-200 py-6">
                    <div
                        ...
                        @if(isset($item['media'][0]->path))
                            <div class="img-box">
                                <img src="{{ asset('storage/' . $item['media'][0]->path) }}" alt="perfume bottle image" class="xl:w-[140px]">
                            </div>
                        @endif
                         <div class="pro-data w-full max-w-sm ">
                            ...
                            <h6 class="font-medium text-lg leading-8 text-indigo-600  max-[550px]:text-center">{{$item['product']->price}}</h6>
                        </div>
                    </div>
                    <div
        ...
        <div class="bg-gray-50 rounded-xl p-6 w-full mb-8 max-lg:max-w-xl max-lg:mx-auto">
            ...
            <div class="flex items-center justify-between w-full py-6">
                @if(isset($cart['total']))
                    ...
                    <h6 class="font-manrope font-medium text-2xl leading-9 text-indigo-500">{{$cart['total']}}</h6>
                @endif
            </div>
        </div>
